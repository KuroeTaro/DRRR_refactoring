...
function init_load_scene_anim()
    ...
    anim_UI_load_scene_loading_text_flash_in_opacity[0] = 0
    ...
    anim_UI_load_scene_loading_text_flash_in_opacity["fix_type"] = true

    anim_UI_load_scene_loading_text_flash_out_x = {}
    anim_UI_load_scene_loading_text_flash_out_x[0] = 1350
    ...
    anim_UI_load_scene_loading_text_flash_out_x["fix_type"] = true

    anim_UI_load_scene_loading_text_flash_out_opacity = {}
    anim_UI_load_scene_loading_text_flash_out_opacity[0] = 1
    ...
    anim_UI_load_scene_loading_text_flash_out_opacity["fix_type"] = true

    anim_UI_load_scene_type_in_mark_flash_in_opacity = {}
    anim_UI_load_scene_type_in_mark_flash_in_opacity[0] = 0
    ...
    anim_UI_load_scene_type_in_mark_flash_in_opacity["fix_type"] = true

    anim_UI_load_scene_type_in_mark_blink_opacity = {}
    anim_UI_load_scene_type_in_mark_blink_opacity[0] = 1
    ...
    anim_UI_load_scene_type_in_mark_blink_opacity["fix_type"] = true

    anim_UI_load_scene_dabo_trig_flash_in_x = {}
    anim_UI_load_scene_dabo_trig_flash_in_x[0] = 1280
    ...
    anim_UI_load_scene_dabo_trig_flash_in_x["fix_type"] = true

    anim_UI_load_scene_dabo_trig_flash_out_x = {}
    anim_UI_load_scene_dabo_trig_flash_out_x[0] = 1300
    ...
    anim_UI_load_scene_dabo_trig_flash_out_x["fix_type"] = true

    anim_UI_load_scene_dabo_trig_flash_out_opacity = {}
    anim_UI_load_scene_dabo_trig_flash_out_opacity[0] = 1
    ...
    anim_UI_load_scene_dabo_trig_flash_out_opacity["fix_type"] = true
