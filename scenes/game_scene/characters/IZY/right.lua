...
function load_game_scene_anim_char_RP()
    -- 站姿待机动画
        ...
        for i = 1,16 do
            anim_char_RP_stand_idle[i*7] = function()
                obj_char_game_scene_char_RP[8] = i
            end
        end
        anim_char_RP_stand_idle[17*7] = function()
            char_obj["f"] = 0
            char_obj[8] = 0
        end
        anim_char_RP_stand_idle["damage"] = 0
        anim_char_RP_stand_idle["guard"] =  nil -- high low all throw air_throw
        anim_char_RP_stand_idle["guard_crush"] = false

    -- overdrive启动动画
        anim_char_RP_overdrive = {}
        ...
        for i = 0,70 do
            anim_char_RP_overdrive[i] = function()
                drain_overdrive()
            end
        end
        anim_char_RP_overdrive[0] = function()
            ...
            insert_VFX_game_scene_char_RP_overdrive_black_overlay()
            
        end
        anim_char_RP_overdrive[3] = function() 
            char_obj[8] = 1
            drain_overdrive()
        ...
        anim_char_RP_overdrive[19] = function() 
            char_obj[8] = 5
            drain_overdrive()
        end
        anim_char_RP_overdrive[28] = function() 
            char_obj[8] = 6
            char_obj["shadow_box_table"] = {
                {
                    {-3.75, -18.13,
        ...
        anim_char_RP_overdrive[30] = function() 
            insert_VFX_game_scene_char_RP_overdrive_airflow()
        end
        anim_char_RP_overdrive[32] = function() 
            char_obj[8] = 8
            char_obj["shadow_box_table"] = {
                {
                    {-10.63, -17.25,
        ...
        anim_char_RP_overdrive[38] = function() 
        ...
        anim_char_RP_overdrive[41] = function() 
            char_obj[8] = 7
        end
        anim_char_RP_overdrive[44] = function() 
            char_obj[8] = 8
        end
        anim_char_RP_overdrive[47] = function() 
            char_obj[8] = 9
        end
        anim_char_RP_overdrive[50] = function() 
            char_obj[8] = 7
        end
        anim_char_RP_overdrive[53] = function() 
            char_obj[8] = 8
        end
        anim_char_RP_overdrive[56] = function() 
            char_obj[8] = 9
        end
        anim_char_RP_overdrive[58] = function() 
            char_obj[8] = 10
            char_obj["shadow_box_table"] = {
                {
                    {-7.00, -15.38,
...
function insert_VFX_game_scene_char_RP_overdrive_badge()
    ...
    obj["draw"] = function(self)
        local camera = obj_stage_game_scene_camera
        local image_sprite_sheet = image_sprite_sheet_VFX_game_scene_RP_overdrive_badge
        local f = self[8]
