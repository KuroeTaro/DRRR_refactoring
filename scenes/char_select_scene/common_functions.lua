function commmon_char_select_scene_reset_char_text_flash_out(obj_char,obj_text,icon_cover,input_id)
    ...
    icon_cover[4] = 0.1
    init_point_linear_anim_with(icon_cover,anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0)
end

function commmon_char_select_scene_reset_char_text_flash_in(obj_char,obj_text,icon_cover,input_id)
    local id = CHAR_SELECT_LR[input_id]
    if input_id == 1 then
    ...
    icon_cover[1] = ICON_COVER_POSITION[id][1]
    icon_cover[2] = ICON_COVER_POSITION[id][2]
    icon_cover[8] = id
    icon_cover[4] = 0
    init_point_linear_anim_with(icon_cover,anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1)
end