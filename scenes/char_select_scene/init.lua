...
function load_char_select_scene_anim()
    ...
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5[0] = {0, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5[5] = {0.5, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5["prop"] = 4
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5["length"] = 5
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5["loop"] = false
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p5["fix_type"] = true

    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0 = {}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0[0] = {0.5, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0[5] = {0, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0["prop"] = 4
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0["length"] = 5
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0["loop"] = false
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p5_0["fix_type"] = true
