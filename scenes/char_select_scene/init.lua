...
function load_char_select_scene_anim()
    ...
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity[0] = {1, 2}
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity[2] = {0.6, 6}
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity[6] = {0.2, 10}
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity[10] = {0.05, 15}
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity[15] = {0, 15}
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity["prop"] = 4
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity["length"] = 15
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity["loop"] = false
    anim_UI_point_linear_char_select_scene_white_solid_flash_out_opacity["fix_type"] = true
    ...
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1[0] = {0, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1[5] = {0.1, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1["prop"] = 4
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1["length"] = 5
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1["loop"] = false
    anim_UI_point_linear_char_select_scene_icon_select_flash_in_opacity_0_0p1["fix_type"] = true

    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0 = {}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0[0] = {0.1, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0[5] = {0, 5}
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0["prop"] = 4
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0["length"] = 5
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0["loop"] = false
    anim_UI_point_linear_char_select_scene_icon_select_flash_out_opacity_0p1_0["fix_type"] = true
    ...
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1[0] = {0.25, 3}
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1[3] = {0.75, 6}
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1[6] = {0.90, 9}
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1[9] = {0.95, 15}
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1[15] = {1, 15}
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1["prop"] = 4
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1["length"] = 15
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1["loop"] = false
    anim_UI_point_linear_char_select_scene_char_select_unselecting_flash_in_opacity_0p25_1["fix_type"] = true

    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25 = {}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25[0] = {1, 3}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25[3] = {0.50, 6}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25[6] = {0.35, 9}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25[9] = {0.30, 15}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25[15] = {0.25, 15}
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25["prop"] = 4
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25["length"] = 15
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25["loop"] = false
    anim_UI_point_linear_char_select_scene_char_select_selecting_flash_out_opacity_1_0p25["fix_type"] = true

    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x = {}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[0] = {0, 1}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[1] = {-25.40, 2}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[2] = {-31.60, 3}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[3] = {-35.40, 5}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[5] = {-40.20, 10}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[10] = {-46.70, 20}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[20] = {-52.60, 30}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[30] = {-55.40, 40}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[40] = {-57.10, 50}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[50] = {-58.20, 60}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[60] = {-58.90, 70}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[70] = {-59.40, 80}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[80] = {-59.70, 90}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[90] = {-59.90, 100}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[100] = {-60, 110}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[110] = {-60, 120}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x[120] = {-60, 120}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x["prop"] = 1
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x["length"] = 120
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x["loop"] = false
    anim_UI_point_linear_char_select_scene_char_select_char_flash_in_x["fix_type"] = false

    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x = {}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[0] = {-60.00, 1}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[1] = {-61.00, 2}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[2] = {-64.75, 3}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[3] = {-74.80, 4}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[4] = {-98.00, 5}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x[5] = {-150.00, 5}
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x["prop"] = 1
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x["length"] = 5
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x["loop"] = false
    anim_UI_point_linear_char_select_scene_char_select_char_flash_out_x["fix_type"] = false
    ...
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[0] = {-226.30, 1}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[1] = {-231.00, 2}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[2] = {-240.00, 3}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[3] = {-268.00, 4}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[4] = {-326.00, 5}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x[5] = {-423.00, 5}
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x["prop"] = 1
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x["length"] = 5
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x["loop"] = false
    anim_UI_point_linear_char_select_scene_char_select_text_flash_out_x["fix_type"] = false

    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0 = {}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0[0] = {1, 3}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0[3] = {0.50, 6}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0[6] = {0.25, 9}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0[9] = {0.10, 15}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0[15] = {0.0, 15}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0["prop"] = 4
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0["length"] = 15
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0["loop"] = false
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_unselecting_flash_out_opacity_1_0["fix_type"] = true

    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1 = {}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1[0] = {0, 3}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1[3] = {0.50, 6}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1[6] = {0.75, 9}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1[9] = {0.90, 15}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1[15] = {1, 15}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1["prop"] = 4
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1["length"] = 15
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1["loop"] = false
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_selecting_flash_in_opacity_0_1["fix_type"] = true

    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0 = {}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0[0] = {1, 1}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0[1] = {0.50, 2}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0[2] = {0.25, 3}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0[3] = {0.1, 5}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0[5] = {0, 5}
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0["prop"] = 4
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0["length"] = 5
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0["loop"] = false
    anim_UI_point_linear_char_select_scene_control_method_bar_mark_locking_flash_out_opacity_1_0["fix_type"] = true
    ...
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[0] = {0.00, 2}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[2] = {0.01, 4}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[4] = {0.03, 6}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[6] = {0.07, 8}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[8] = {0.13, 10}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[10] = {0.23, 12}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[12] = {0.39, 13}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[13] = {0.52, 14}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[14] = {0.70, 15}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out[15] = {1.00, 15}
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out["prop"] = 4
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out["length"] = 15
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out["loop"] = false
    anim_UI_point_linear_char_select_scene_black_solid_scene_flash_out["fix_type"] = false
